...
export const translations: Record<Language, LocaleStrings> = {
    it: {
        ...
        docs: {
            ...
            deviceConnectionDescription: 'Collega un dispositivo supportato via Bluetooth per iniziare il monitoraggio in tempo reale (HR/HRV e, dove previsto, altri segnali biometrici).',
            ...
            supportedDevicesDescription: '• Polar 360\n• Polar Loop\n• Polar H10 (fascia ECG)\n• Muse 2 (EEG) — in arrivo\n• Android Wear OS (es. Pixel Watch, Samsung Galaxy Watch, ecc.)',
    ...
    en: {
        ...
        docs: {
            ...
            deviceConnectionDescription: 'Connect a supported device via Bluetooth to start real-time monitoring (HR/HRV and, where available, other biometric signals).',
            ...
            supportedDevicesDescription: '• Polar 360\n• Polar Loop\n• Polar H10 (ECG chest strap)\n• Muse 2 (EEG) — coming soon\n• Android Wear OS (e.g. Pixel Watch, Samsung Galaxy Watch, etc.)',
